...
class ComicList : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //TODO ändra recycleviewn här från modelViewn
...
//            }
    ...
    private fun generateComicList(heroList: List<MarvelItemDataWrapper>): List<MarvelItem> {
...
//                heroList[0].data.results[x].imageUrl.path,
//                //heroList[0].data.results[x].imageUrl.extension, //TODO vete sjutton
//            )
//            list += item
//        }
        return list
